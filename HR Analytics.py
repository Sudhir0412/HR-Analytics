...
from sklearn.metrics import accuracy_score, confusion_matrix, recall_score,roc_curve, roc_auc_score, precision_score
...
pred = np.where(model_train.predict_proba(X_test)[:,1] >= THRESHOLD, 1, 0)
